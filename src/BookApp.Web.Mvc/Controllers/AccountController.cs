...
using BookApp.Sessions;
using BookApp.Web.Models.Account;
using BookApp.Web.Views.Shared.Components.TenantChange;

namespace BookApp.Web.Controllers
{
    public class AccountController : BookAppControllerBase
    {
