...
namespace BookApp.Migrations
{
    ...
    [Migration("20230419064045_DepartmentFK_ChangeToNullable_From_BorrowTbl")]
    partial class DepartmentFK_ChangeToNullable_From_BorrowTbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookApp.Entities.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BookApp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BookApp.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("BookApp.Entities.BookInfo", b =>
                {
                    b.HasOne("BookApp.Entities.BookCategory", "BookCategories")
                        .WithMany()
            ...
            modelBuilder.Entity("BookApp.Entities.Student", b =>
                {
                    b.HasOne("BookApp.Entities.Department", "StudentDepartment")
                        .WithMany()
