...
{
    public abstract class BookAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BookAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BookAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BookAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BookAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BookAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BookAppDbContext, Task<T>> func)
        {
            T result;
